...
_C.MODEL.PROMPT.PPO = True  # PPO (for RL) or TS (for MAB)
_C.MODEL.PROMPT.GATE_GRADS_IDENT = True  # gate grads identification or prompt norm identification
_C.MODEL.PROMPT.CLP_MAX_NORM = 0.25
_C.MODEL.PROMPT.REWARD_WARMUP_EPOCH = 1
_C.MODEL.PROMPT.PPO_DISCOUNT_FACTOR = 1.0
_C.MODEL.PROMPT.PPO_K_EPOCH = 60
""" for pro-vpt """
